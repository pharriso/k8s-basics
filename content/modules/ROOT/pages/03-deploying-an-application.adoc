...
In this example, the URL for accessing the front end web application will be : `http://parksmap-wksp-{user}.{openshift_cluster_ingress_domain}` 


 NOTE: make sure that you follow http and not https, sometimes the browser may enforce https so you have to manually change on the browser url
