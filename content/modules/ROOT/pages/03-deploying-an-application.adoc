...
In this example, the URL for accessing the front end web application will be (make sure that you follow http and not https, sometimes the browser may enforce https so you have to manually change on the browser url):
