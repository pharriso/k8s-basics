...
If you look closely, you might notice that there are some more labels in the abouve yaml. These appear after the 'template' line. 
...
It would be a good idea if we had some of labels defined in the template as well. To do this we'll use the `kubectl edit` command. In your terminal window type:
