...
Find the section under template called labels, you should see `app: parksmap` there. Then, **delete** this whole line.

Then, starting from the line that you just deleted and making sure you take care of the identations, copy and paste the following labels:
